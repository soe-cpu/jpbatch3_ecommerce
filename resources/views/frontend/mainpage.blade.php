        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="{{asset('backend_asset/images/banner.jpg')}}" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="{{asset('backend_asset/images/banner.jpg')}}" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="{{asset('backend_asset/images/banner.jpg')}}" alt="Third slide">
            </div>
          </div>
      ...
      <div class="col-lg-3 col-md-6 my-4">
        <div class="card h-100">
          ...
          <div class="card-footer">
            ...
            <a href="javascript:void(0)" class="btn btn-success item-add addtocart"data-id="{{$item->id}}" data-name="{{$item->name}}" data-photo="{{$item->photo}}" data-price="{{$item->price}}">Add to Cart</a>
          </div>
        </div>
      </div>
      @endforeach
