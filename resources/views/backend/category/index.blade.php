...
@section('content')
  <main class="app-content">
    ...
    <div class="row">
      <div class="col-md-12">
            <a href="{{route('categories.create')}}" class="btn btn-primary float-right my-2">Add New</a>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
          ...
          <table class="table table-bordered dataTable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$row->name}}</td>
                <td>
                  <a href="{{route('categories.show',$row->id)}}" class="btn btn-primary btn-sm">Detail</a>
